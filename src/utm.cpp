...
void CoordinateTransition::UTMXYToLatLon(double utm_x, double utm_y,double &lat, double &lon)
{
...
void CoordinateTransition::ThetaToHeading(const double theta_radian, double velocity_x, double velocity_y, double &heading)
{
  // Stationary state
...
void CoordinateTransition::MathLanLonToXY(const double lat_radian, const double lon_radian, const double central_meridian_radian, double &x, double &y)
{
  // Precalculate ep2
...
void CoordinateTransition::MathXYToLanLon(const double x, const double y, const double central_meridian_radian, double &lat_radian, double &lon_radian)
{
